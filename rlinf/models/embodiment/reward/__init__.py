...
from rlinf.models.embodiment.reward.procvlm_reward_model import ProcVLMHistoryRewardModel
...
reward_model_registry = {
    ...
    "procvlm_history_vlm": ProcVLMHistoryRewardModel,
}
